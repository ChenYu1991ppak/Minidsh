...
服务名，经 profile 的 ``remove: [pydsh.shell-local]`` + ``add pydsh.shell-sandbox``
...
from pydsh.packages.services.sandbox.definition import SandboxExecutionPolicy

__all__ = ["SandboxShellService"]

name = "pydsh.shell-sandbox"
