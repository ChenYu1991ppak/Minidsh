...
from pydsh.packages.services.prompt.definition import PromptAssembly, SystemPromptService
...
class LocalSystemPromptService(SystemPromptService, CapabilityProvider):
    ...
    def section(self, name: str, text: str, order: int = 0):
        from pydsh.packages.services.prompt.definition import PromptSection
