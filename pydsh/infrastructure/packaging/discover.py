"""插件发现：entry-point 组 ``pydsh.plugins``（对齐官方 npm bundle 的 Python 版）。

第三方包在 pyproject.toml 声明：
    [project.entry-points."pydsh.plugins"]
...
from pydsh.cordis import normalize_plugin

__all__ = ["discover_plugins", "entry_point_resolver"]

ENTRY_POINT_GROUP = "pydsh.plugins"
